...
/*   Updated: 2021/03/19 21:14:55 by gshona           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			init_philos(t_simulation *sim)
{
	...
	while (i < c)
	{
		...
		sim->philos[i].l_fork = sim->forks;
		sim->philos[i].r_fork = sim->forks;
		...
		sim->philos[i].eat_up_trigger = sim->all_eated_up_trigger;
		i++;
	}
}
